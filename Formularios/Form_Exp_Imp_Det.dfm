object FrExp_Imp_Det: TFrExp_Imp_Det
  Left = 0
  Top = 0
  Caption = 'FrExp_Imp_Det'
  ClientHeight = 513
  ClientWidth = 759
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Label4: TLabel
      ...
      Width = 92
      Height = 16
      Caption = '&Sustituto Actual'
      FocusControl = SUSTITUTO_OLD
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object Label7: TLabel
      ...
      Width = 91
      Height = 16
      Caption = 'S&ustituto Nuevo'
      FocusControl = SUSTITUTO_NEW
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CAMPO: TOvcDbPictureField
      Left = 113
      Top = 6
      Width = 330
      Height = 24
      ...
      PictureMask = '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
      TabOrder = 0
      OnUserValidation = CAMPOUserValidation
    end
    object LONGITUD: TOvcDbPictureField
      Left = 113
      Top = 87
      Width = 330
      Height = 24
    ...
    object ID_PRIMARY_KEY: TDBCheckBox
      Left = 462
      Top = 10
      Width = 119
      Height = 17
      Caption = 'Llave Primaria'
      DataField = 'ID_PRIMARY_KEY'
      TabOrder = 7
      ValueChecked = 'S'
      ValueUnchecked = 'N'
    end
    ...
    object ALINEACION: TDBRadioGroup
      Left = 462
      Top = 33
      Width = 81
      Height = 73
    ...
    object CARACTER: TOvcDbPictureField
      Left = 515
      Top = 110
      Width = 28
      Height = 24
    ...
    object CONSTANTE: TOvcDbPictureField
      Left = 113
      Top = 116
      Width = 330
      Height = 24
    ...
    object SUSTITUTO_OLD: TOvcDbPictureField
      Left = 113
      Top = 145
      Width = 330
      Height = 24
      DataField = 'SUSTITUTO_OLD'
      FieldType = ftString
      CaretOvr.Shape = csBlock
      Controller = OvcController1
      EFColors.Disabled.BackColor = clWindow
    ...
    object SUSTITUTO_NEW: TOvcDbPictureField
      Left = 113
      Top = 174
      Width = 330
      Height = 24
      DataField = 'SUSTITUTO_NEW'
      FieldType = ftString
      CaretOvr.Shape = csBlock
      Controller = OvcController1
      EFColors.Disabled.BackColor = clWindow
