object FrPUC: TFrPUC
  ...
  object PnlRegistros: TPanel
    ...
    object CODIGO_PUC: TOvcDbPictureField
      Left = 61
      Top = 14
      Width = 164
      Height = 24
      DataField = 'CODIGO_PUC'
      FieldType = ftString
      ...
      PictureMask = '!!!!!!!!!!!!!!!!!!!!'
      TabOrder = 0
      OnExit = CODIGO_PUCExit
      OnUserValidation = CODIGO_PUCUserValidation
    end
