object FrTercero_Sinonimo: TFrTercero_Sinonimo
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'FrTercero_Sinonimo'
  ClientHeight = 485
  ClientWidth = 820
  Color = clBtnFace
    ...
    object Paginas: TPageControl
      ...
      object Pag01: TTabSheet
        ...
        object Label18: TLabel
          ...
          FocusControl = ACTIVIDAD_ECONOMICA
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          Font.Name = 'Arial'
        ...
        object TIPO_DOCUMENTO: TDBRadioGroup
          Left = 8
          Top = 8
          Width = 257
          Height = 169
          ...
          Items.Strings = (
            ...
            'Tarjeta de Extranjer'#237'a'
            'C'#233'dula de Extranjer'#237'a'
            'NIT'
            'Pasaporte'
            'Documento de Identificaci'#243'n Extranjero')
          TabOrder = 0
          Values.Strings = (
            'R.C'
            'T.I'
        ...
        object TIPO_PERSONA: TDBRadioGroup
          Left = 279
          Top = 10
          Width = 185
          Height = 67
        ...
        object TIPO_REGIMEN: TDBRadioGroup
          Left = 279
          Top = 83
          Width = 185
          Height = 94
          Caption = 'Tipo de Regimen'
          DataField = 'TIPO_REGIMEN'
          Items.Strings = (
            'No Aplica'
            'Simplificado'
            'Com'#250'n')
        ...
        object GRAN_CONTRIBUYENTE: TDBCheckBox
          Left = 487
          Top = 19
          Width = 239
          Height = 17
          Caption = 'Gran contribuyente'
          DataField = 'GRAN_CONTRIBUYENTE'
          TabOrder = 3
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        end
        object AUTORETENEDOR: TDBCheckBox
          Left = 487
          Top = 50
          Width = 239
          Height = 17
          Caption = 'Autoretenedor'
          DataField = 'AUTORETENEDOR'
          TabOrder = 4
          ValueChecked = 'S'
          ValueUnchecked = 'N'
        end
        object ACTIVIDAD_ECONOMICA: TOvcDbPictureField
          Left = 614
          Top = 83
          Width = 40
          Height = 24
