...
type
  TFrInfo_Vendor_Product_Id = class(TForm)
    DevStrings: TListBox;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  FrInfo_Vendor_Product_Id: TFrInfo_Vendor_Product_Id;

implementation

{$R *.DFM}

procedure TFrInfo_Vendor_Product_Id.FormShow(Sender: TObject);
var
  I: Integer;
begin
