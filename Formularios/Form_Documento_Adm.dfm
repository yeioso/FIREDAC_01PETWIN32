object FrDocumento_Adm: TFrDocumento_Adm
  Left = 0
  Top = 0
  Caption = 'FrDocumento_Adm'
  ClientHeight = 584
  ClientWidth = 1044
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 16
      Caption = '&Codigo'
      FocusControl = CODIGO_DOCUMENTO_ADM
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CODIGO_DOCUMENTO_ADM: TOvcDbPictureField
      Left = 61
      Top = 7
      Width = 57
      Height = 24
      ...
      PictureMask = '!!!!'
      TabOrder = 0
      OnExit = CODIGO_DOCUMENTO_ADMExit
      OnUserValidation = CODIGO_DOCUMENTO_ADMUserValidation
    end
    ...
    object gbDocumento: TGroupBox
      ...
      object Label3: TLabel
        ...
        FocusControl = DOCUMENTO_INICIAL
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
      ...
      object Label4: TLabel
        ...
        Width = 106
        Height = 16
        Caption = 'D&ocumento Actual'
        FocusControl = DOCUMENTO_ACTUAL
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
      ...
      object Label5: TLabel
        ...
        Width = 98
        Height = 16
        Caption = 'Doc&umento Final'
        FocusControl = DOCUMENTO_FINAL
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
      ...
      object DOCUMENTO_INICIAL: TOvcDbPictureField
        Left = 119
        Top = 21
        Width = 184
        Height = 24
        ...
        PictureMask = '!!!!!!!!!!!!!!!!!!!!'
        TabOrder = 0
        OnExit = DOCUMENTO_INICIALExit
      end
      object DOCUMENTO_ACTUAL: TOvcDbPictureField
        Left = 119
        Top = 47
        Width = 184
        Height = 24
        ...
        PictureMask = '!!!!!!!!!!!!!!!!!!!!'
        TabOrder = 1
        OnExit = DOCUMENTO_ACTUALExit
      end
      object DOCUMENTO_FINAL: TOvcDbPictureField
        Left = 119
        Top = 73
        Width = 184
        Height = 24
    ...
    object FORMATO: TOvcDbPictureField
      Left = 72
      Top = 176
      Width = 453
      Height = 24
    ...
    object ID_SALIDA: TDBRadioGroup
      Left = 798
      Top = 34
      Width = 121
      Height = 136
    ...
    object NRO_COPIAS: TOvcDbPictureField
      Left = 652
      Top = 176
      Width = 39
      Height = 24
    ...
    object IMPRESORA: TOvcDbPictureField
      Left = 72
      Top = 203
      Width = 453
      Height = 24
