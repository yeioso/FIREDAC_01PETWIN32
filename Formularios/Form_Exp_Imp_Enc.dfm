object FrExp_Imp_Enc: TFrExp_Imp_Enc
  Left = 0
  Top = 0
  Caption = 'FrExp_Imp_Enc'
  ClientHeight = 547
  ClientWidth = 838
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Pages: TPageControl
      ...
      object Pag00: TTabSheet
        ...
        object CODIGO_EXP_IMP: TOvcDbPictureField
          Left = 77
          Top = 5
          Width = 40
          Height = 24
          DataField = 'CODIGO_EXP_IMP'
          FieldType = ftString
          ...
          PictureMask = '!!'
          TabOrder = 0
          OnExit = CODIGO_EXP_IMPExit
          OnUserValidation = CODIGO_EXP_IMPUserValidation
        end
        ...
        object ORIGEN_DATOS: TDBRadioGroup
          Left = 10
          Top = 65
          Width = 383
          Height = 47
        ...
        object DELIMITADOR: TOvcDbPictureField
          Left = 493
          Top = 78
          Width = 40
          Height = 24
          DataField = 'DELIMITADOR'
          FieldType = ftString
          CaretOvr.Shape = csBlock
          Controller = OvcController1
          EFColors.Disabled.BackColor = clWindow
          ...
          PictureMask = '!'
          TabOrder = 2
          OnUserValidation = DELIMITADORUserValidation
        end
        object ESTRUCTURA: TDBRadioGroup
          Left = 417
          Top = 3
          Width = 128
          Height = 70
      ...
      object Pag01: TTabSheet
        ...
        object ORIGEN: TDBMemo
          ...
          DataField = 'ORIGEN'
          TabOrder = 0
          OnDblClick = ORIGENDblClick
        end
      end
      object Pag02: TTabSheet
        Caption = 'Destino'
        ImageIndex = 2
        object DESTINO: TDBMemo
          Left = 0
          Top = 0
          Width = 828
          Height = 115
      ...
      object Pag03: TTabSheet
        ...
        object GBORIGEN: TGroupBox
          ...
          Caption = 'Origen'
          TabOrder = 0
          object DATASOURCE_ORIGEN: TDBMemo
            Left = 2
            Top = 15
            Width = 824
            Height = 283
            Align = alTop
            DataField = 'DATASOURCE_ORIGEN'
            TabOrder = 0
            OnDblClick = DATASOURCE_ORIGENDblClick
          end
        end
        object GBDESTINO: TGroupBox
          ...
          Caption = 'Destino'
          TabOrder = 1
          object DATASOURCE_DESTINO: TDBMemo
            Left = 2
            Top = 15
            Width = 824
            Height = 43
            Align = alClient
            DataField = 'DATASOURCE_DESTINO'
            TabOrder = 0
            OnDblClick = DATASOURCE_DESTINODblClick
          end
        end
      end
