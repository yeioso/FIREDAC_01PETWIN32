object FrCentro_Costos: TFrCentro_Costos
  Left = 0
  Top = 0
  Caption = 'FrCentro_Costos'
  ClientHeight = 382
  ClientWidth = 759
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 16
      Caption = '&Codigo'
      FocusControl = CODIGO_CENTRO_COSTOS
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CODIGO_CENTRO_COSTOS: TOvcDbPictureField
      Left = 61
      Top = 6
      Width = 164
      Height = 24
      DataField = 'CODIGO_CENTRO_COSTOS'
      FieldType = ftString
      ...
      PictureMask = '!!!!!!!!!!!!!!!!!!!!'
      TabOrder = 0
      OnExit = CODIGO_CENTRO_COSTOSExit
      OnUserValidation = CODIGO_CENTRO_COSTOSUserValidation
    end
