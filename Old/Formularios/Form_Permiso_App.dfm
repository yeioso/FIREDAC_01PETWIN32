object FrPermiso_App: TFrPermiso_App
  Left = 0
  Top = 0
  Caption = 'FrPermiso_App'
  ClientHeight = 482
  ClientWidth = 954
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object HABILITA_OPCION: TDBCheckBox
      Left = 11
      Top = 113
      Width = 158
      Height = 17
    ...
    object CONSECUTIVO: TOvcDbPictureField
      ...
      PictureMask = 'XXXX'
      TabOrder = 1
      OnExit = CONSECUTIVOExit
    end
    object OPCIONES: TListBox
      Left = 392
      Top = 12
      Width = 193
      Height = 118
