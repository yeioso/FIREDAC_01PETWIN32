object FrPrecargada: TFrPrecargada
  Left = 0
  Top = 0
  Caption = 'FrPrecargada'
  ClientHeight = 497
  ClientWidth = 759
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object BtnCODIGO_TERCERO: TSpeedButton
      Left = 267
      Top = 64
      Width = 25
      Height = 24
      ...
      ParentFont = False
      OnClick = BtnCODIGO_TERCEROClick
    end
    object lbNombre_CODIGO_TERCERO: TLabel
      Left = 295
      Top = 68
      Width = 182
      Height = 16
      Caption = 'lbNombre_CODIGO_TERCERO'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object BtnCODIGO_SINONIMO: TSpeedButton
      Left = 267
      Top = 90
      Width = 25
      Height = 23
      ...
      Glyph.Data = {
        ...
        FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
      ParentFont = False
      OnClick = BtnCODIGO_SINONIMOClick
    end
    object lbNombre_CODIGO_SINONIMO: TLabel
      Left = 295
      Top = 94
      Width = 184
      Height = 16
      Caption = 'lbNombre_CODIGO_SINONIMO'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object BtnLISTA_PRECIO: TSpeedButton
      Left = 267
      Top = 116
      Width = 25
      Height = 24
      ...
      Glyph.Data = {
        ...
        FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
      ParentFont = False
      OnClick = BtnLISTA_PRECIOClick
    end
    object lbNombre_LISTA_PRECIO: TLabel
      Left = 295
      Top = 120
      Width = 152
      Height = 16
      Caption = 'lbNombre_LISTA_PRECIO'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object BtnCODIGO_VENDEDOR: TSpeedButton
      Left = 267
      Top = 143
      Width = 25
      Height = 23
      ...
      Glyph.Data = {
        ...
        FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
      ParentFont = False
      OnClick = BtnCODIGO_VENDEDORClick
    end
    object lbNombre_CODIGO_VENDEDOR: TLabel
      Left = 295
      Top = 146
      Width = 193
      Height = 16
      Caption = 'lbNombre_CODIGO_VENDEDOR'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object BtnCODIGO_BASE: TSpeedButton
      Left = 267
      Top = 168
      Width = 25
      Height = 23
      ...
      Glyph.Data = {
        ...
        FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
      ParentFont = False
      OnClick = BtnCODIGO_BASEClick
    end
    object lbNombre_CODIGO_BASE: TLabel
      Left = 295
      Top = 171
      Width = 156
      Height = 16
      Caption = 'lbNombre_CODIGO_BASE'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object lbNombre_CODIGO_PRODUCTO: TLabel
      Left = 295
      Top = 199
      Width = 192
      Height = 16
      Caption = 'lbNombre_CODIGO_PRODUCTO'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object LISTA_PRECIO: TOvcDbPictureField
      Left = 100
      Top = 116
      Width = 165
      Height = 24
      ...
      PictureMask = '!!'
      TabOrder = 2
      OnExit = LISTA_PRECIOExit
      OnKeyDown = LISTA_PRECIOKeyDown
      OnUserValidation = LISTA_PRECIOUserValidation
    end
