object FrContrato_Salario: TFrContrato_Salario
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'FrContrato_Salario'
  ClientHeight = 533
  ClientWidth = 769
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object BtnFechaInicial: TSpeedButton
      Left = 184
      Top = 58
      Width = 27
      Height = 24
    ...
    object BtnFechaFinal: TSpeedButton
      Left = 184
      Top = 85
      Width = 27
      Height = 24
    ...
    object CODIGO_SALARIO: TOvcDbPictureField
      Left = 86
      Top = 10
      Width = 195
      Height = 21
      DataField = 'CODIGO_SALARIO'
      ...
      PictureMask = '!!!!!!!!!!!!!!!!!!!!'
      TabOrder = 0
      OnExit = CODIGO_SALARIOExit
      OnUserValidation = CODIGO_SALARIOUserValidation
    end
    ...
    object FECHA_INICIAL: TOvcDbPictureField
      Left = 85
      Top = 58
      Width = 97
      Height = 24
      ...
      TabOrder = 2
      OnKeyDown = FECHA_INICIALKeyDown
      OnUserValidation = FECHA_INICIALUserValidation
    end
    object FECHA_FINAL: TOvcDbPictureField
      Left = 85
      Top = 85
      Width = 97
      Height = 24
      ...
      PictureMask = 'yyyy-mm-dd'
      TabOrder = 3
      OnKeyDown = FECHA_FINALKeyDown
      OnUserValidation = FECHA_FINALUserValidation
    end
    object PORCENTAJE: TOvcDbPictureField
      Left = 85
      Top = 112
      Width = 126
      Height = 24
    ...
    object VALOR: TOvcDbPictureField
      Left = 85
      Top = 138
      Width = 126
      Height = 24
