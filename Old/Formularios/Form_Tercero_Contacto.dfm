object FrTercero_Contacto: TFrTercero_Contacto
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'FrTercero_Contacto'
  ClientHeight = 441
  ClientWidth = 740
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object lbNombreCargo: TLabel
      Left = 174
      Top = 141
      Width = 89
      Height = 16
      Caption = 'lbNombreCargo'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object lbNombreArea: TLabel
      Left = 174
      Top = 165
      Width = 82
      Height = 16
      Caption = 'lbNombreArea'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CODIGO_CONTACTO: TOvcDbPictureField
      Left = 82
      Top = 8
      Width = 159
      Height = 24
      DataField = 'CODIGO_CONTACTO'
      FieldType = ftString
      CaretOvr.Shape = csBlock
      Controller = OvcController1
      EFColors.Disabled.BackColor = clWindow
      ...
      PictureMask = '!!!!!!!!!!!!!!!!!!!!'
      TabOrder = 0
      OnExit = CODIGO_CONTACTOExit
      OnUserValidation = CODIGO_CONTACTOUserValidation
    end
    ...
    object TELEFONO: TOvcDbPictureField
      Left = 82
      Top = 58
      Width = 318
      Height = 24
    ...
    object CODIGO_CARGO: TOvcDbPictureField
      Left = 82
      Top = 135
      Width = 56
      Height = 21
      ...
      PictureMask = '!!!!'
      TabOrder = 5
      OnExit = CODIGO_CARGOExit
      OnKeyDown = CODIGO_CARGOKeyDown
      OnUserValidation = CODIGO_CARGOUserValidation
    end
    object CODIGO_AREA: TOvcDbPictureField
      Left = 82
      Top = 160
      Width = 56
      Height = 21
      ...
      PictureMask = '!!!!'
      TabOrder = 6
      OnExit = CODIGO_AREAExit
      OnKeyDown = CODIGO_AREAKeyDown
      OnUserValidation = CODIGO_AREAUserValidation
    end
    object EMAIL: TOvcDbPictureField
      Left = 82
      Top = 84
      Width = 318
      Height = 24
    ...
    object WEBSITE: TOvcDbPictureField
      Left = 82
      Top = 109
      Width = 318
      Height = 24
    ...
    object ID_TRATAMIENTO: TDBCheckBox
      Left = 459
      Top = 44
      Width = 222
      Height = 17
      Caption = '&Est'#225' de acuerdo al tratamiento de datos'
      DataField = 'ID_TRATAMIENTO'
      TabOrder = 9
      ValueChecked = 'S'
      ValueUnchecked = 'N'
    end
