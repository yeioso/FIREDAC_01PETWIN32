object FrProducto_Bodega: TFrProducto_Bodega
  Left = 0
  Top = 0
  Caption = 'FrProducto_Bodega'
  ClientHeight = 382
  ClientWidth = 759
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object lbNombreBodega: TLabel
      Left = 153
      Top = 10
      Width = 99
      Height = 16
      Caption = 'lbNombreBodega'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object EXISTENCIA: TOvcDbPictureField
      Left = 74
      Top = 57
      Width = 111
      Height = 24
