object FrComprobante: TFrComprobante
  Left = 0
  Top = 0
  Caption = 'FrComprobante'
  ClientHeight = 382
  ClientWidth = 759
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 16
      Caption = '&Codigo'
      FocusControl = CODIGO_COMPROBANTE
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CODIGO_COMPROBANTE: TOvcDbPictureField
      Left = 61
      Top = 3
      Width = 52
      Height = 24
      DataField = 'CODIGO_COMPROBANTE'
      FieldType = ftString
      ...
      PictureMask = '!!!!'
      TabOrder = 0
      OnExit = CODIGO_COMPROBANTEExit
      OnUserValidation = CODIGO_COMPROBANTEUserValidation
    end
