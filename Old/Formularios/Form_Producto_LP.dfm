object FrProducto_LP: TFrProducto_LP
  Left = 0
  Top = 0
  Caption = 'FrProducto_LP'
  ClientHeight = 590
  ClientWidth = 1084
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 16
      Caption = '&Codigo'
      FocusControl = CODIGO_PRODUCTO_LP
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object Label3: TLabel
      ...
      Width = 69
      Height = 16
      Caption = 'R&ango Final'
      FocusControl = RANGO_FINAL
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CODIGO_PRODUCTO_LP: TOvcDbPictureField
      Left = 90
      Top = 7
      Width = 111
      Height = 24
      DataField = 'CODIGO_PRODUCTO_LP'
      FieldType = ftString
      ...
      PictureMask = '!!!!!!!!!!'
      TabOrder = 0
      OnExit = CODIGO_PRODUCTO_LPExit
      OnUserValidation = CODIGO_PRODUCTO_LPUserValidation
    end
    ...
    object RANGO_INICIAL: TOvcDbPictureField
      Left = 90
      Top = 57
      Width = 111
      Height = 24
    ...
    object RANGO_FINAL: TOvcDbPictureField
      Left = 309
      Top = 57
      Width = 111
      Height = 24
    ...
    object gbUtilidad: TGroupBox
      ...
      object Label5: TLabel
        ...
        Height = 16
        Caption = '&Utilidad (%)'
        FocusControl = PORCENTAJE_UTILIDAD
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Arial'
      ...
      object PORCENTAJE_UTILIDAD: TOvcDbPictureField
        Left = 110
        Top = 53
        Width = 130
        Height = 24
    ...
    object TIPO_LP: TDBRadioGroup
      Left = 710
      Top = 12
      Width = 123
      Height = 133
      Caption = 'Tipo de Lista de Precio'
      DataField = 'TIPO_LP'
      Items.Strings = (
        'Cantidad'
        'Valor'
