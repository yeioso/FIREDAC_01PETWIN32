object FrProducto_Observacion: TFrProducto_Observacion
  Left = 0
  Top = 0
  Caption = 'FrProducto_Observacion'
  ClientHeight = 448
  ClientWidth = 759
  Color = clBtnFace
  ...
  object PnlRegistros: TPanel
    ...
    object Label7: TLabel
      ...
      Height = 16
      Caption = '&C'#243'digo'
      FocusControl = CODIGO_OBSERVACION
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object CODIGO_OBSERVACION: TOvcDbPictureField
      Left = 57
      Top = 3
      Width = 155
      Height = 24
      DataField = 'CODIGO_OBSERVACION'
      FieldType = ftString
      CaretOvr.Shape = csBlock
      Controller = OvcController1
      EFColors.Disabled.BackColor = clWindow
